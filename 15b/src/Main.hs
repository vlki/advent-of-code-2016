...
fallsThrough positions numPositions = sum (modLists (addLists [1, 2, 3, 4, 5, 6, 7] positions) numPositions) == 0
...
main :: IO ()
main = do
    putStrLn $ show $ findFirstFallThrough [15, 2, 4, 2, 2, 0, 0] [17, 3, 19, 13, 7, 5, 11] 0
