...
leeShortestFromTo :: Pos -> Pos -> Maze -> Int
leeShortestFromTo from to maze = getPosValue to $ leeRun from maze

main :: IO ()
main = do
    putStrLn $ show $ leeShortestFromTo (1, 1) (31, 39) $ generateMaze
